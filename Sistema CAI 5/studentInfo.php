...
$sentencia = "SELECT * FROM alumnos WHERE Matricula = ".$matricula;
   ...
   foreach ($base_de_datos ->query($sentencia) as $row ) {
    $nombreteacher = $row['Nombre']." ".$row['Apellidos'];
   }
...
<hr>
<h4>Teacher</h4>
<label><?php echo $nombreteacher; ?></label>
<hr>
...
<label for="cal">Calificacion:</label>
    <input name="calif" type="calif" class="form-control" requiered type="text" id="calif" placeholder="calification"><br>
